...
/**
 * Extended Walker class for use with  Bootstrap 4.0.0b Dropdown menus and Submenus in Wordpress.
 * Edited to support n-levels submenu and Boostrap 4b menu styles
 * @author @jaycbrf4 https://github.com/jaycbrf4
